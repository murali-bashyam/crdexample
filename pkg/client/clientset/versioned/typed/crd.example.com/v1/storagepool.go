...
import (
	...
	scheme "github.com/murali-bashyam/crdexample/pkg/client/clientset/versioned/scheme"
...
type StoragePoolInterface interface {
	Create(*v1.StoragePool) (*v1.StoragePool, error)
	Update(*v1.StoragePool) (*v1.StoragePool, error)
	Delete(name string, options *metav1.DeleteOptions) error
	DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error
	Get(name string, options metav1.GetOptions) (*v1.StoragePool, error)
	List(opts metav1.ListOptions) (*v1.StoragePoolList, error)
	Watch(opts metav1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.StoragePool, err error)
...
func newStoragePools(c *CrdV1Client, namespace string) *storagePools {
	return &storagePools{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *storagePools) Get(name string, options metav1.GetOptions) (result *v1.StoragePool, err error) {
...
func (c *storagePools) List(opts metav1.ListOptions) (result *v1.StoragePoolList, err error) {
...
func (c *storagePools) Watch(opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *storagePools) Create(storagePool *v1.StoragePool) (result *v1.StoragePool, err error) {
	result = &v1.StoragePool{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("storagepools").
...
func (c *storagePools) Update(storagePool *v1.StoragePool) (result *v1.StoragePool, err error) {
	result = &v1.StoragePool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("storagepools").
...
func (c *storagePools) Delete(name string, options *metav1.DeleteOptions) error {
...
func (c *storagePools) DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *storagePools) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.StoragePool, err error) {
	result = &v1.StoragePool{}
